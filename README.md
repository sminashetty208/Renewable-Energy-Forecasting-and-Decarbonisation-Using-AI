...
The study applies both traditional Machine Learning and Deep Learning techniques to compare forecasting performance and identify the most effective models for renewable energy prediction. In addition to forecasting, the project incorporates scenario-based sustainability modelling to analyse potential carbon emission reduction pathways under different renewable energy transition strategies.
